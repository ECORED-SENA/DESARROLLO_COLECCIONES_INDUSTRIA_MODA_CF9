export default {
  global: {
    componenteFormativo: 'Patronaje infantil',
    descripcionCurso:
      'El patronaje se convierte en un área fundamental a trabajar en el proceso de la producción de prendas de vestir. Cada una de las líneas de vestir representa retos diferentes para el patronista, es así como en este componente se presentan los conceptos principales del patronaje infantil (niños y adolescentes entre los 2 y 16 años) las medidas corporales, los patrones básicos y algunos desarrollos.',
  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '7',
        titulo: 'Básico del corpiño y la blusa de niña',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema8',
        icono: 'far fa-file-alt',
        numero: '8',
        titulo: 'Variaciones de la blusa: cuellos, almillas y mangas',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema9',
        icono: 'far fa-file-alt',
        numero: '9',
        titulo: 'Desarrollo de modelos de blusa niña',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema10',
        icono: 'far fa-file-alt',
        numero: '10',
        titulo: 'Escalado de la blusa niña',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema11',
        icono: 'far fa-file-alt',
        numero: '11',
        titulo: 'Básico de la falda niña',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema12',
